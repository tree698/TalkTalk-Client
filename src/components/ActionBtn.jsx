...
export default function ActionBtn() {
  ...
  return (
    <section className="pt-[100px] md:pt-[120px] lg:pt-[140px] px-20 md:px-8 mb-8 md:mb-10 lg:mb-12 grid grid-rows-3 gap-y-1 md:grid md:grid-cols-3 md:grid-rows-1 md:gap-x-3">
